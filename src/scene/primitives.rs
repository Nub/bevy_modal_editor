...
/// Spawn a particle effect entity with default settings.
/// The `ParticleEffectMarker` is serializable; the actual `ParticleEffect`
/// runtime component is regenerated by `ParticlePlugin`'s change detection.
